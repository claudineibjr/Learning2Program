var Library = (function () {
    ...
    Library.newMatriz = function (linhas, colunas) {
        // Criando matriz	
    ...
    Library.showMatriz = function (matriz, bMatriz, separator) {
        var linhas, colunas;
    ...
    Library.obterValorEntre = function (valor, marcadorInicial, marcadorFinal) {
        var resultado;
    ...
    Library.replaceValues = function (value, valueSubstituted, valueToSubstitute) {
        var valueAux;
        valueAux = "";
    ...
    Library.truncNum = function (numero, precisao) {
    ...
    Library.truncateDecimals = function (num, digits) {
